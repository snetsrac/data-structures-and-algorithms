...
public class ExternalChainingHashMap<K, V> {
     ...
     * to check the entire chain for duplicate keys first.
     *
    ...
    public V put(K key, V value) {
        ...
        if (key == null || value == null) {
            throw new IllegalArgumentException("ExternalChainingHashMap key and value must not be null.");
        }
    ...
    public String toString() {
        ...
        for (ExternalChainingMapEntry<K, V> entry : table) {
            if (entry == null) {
                ...
                ExternalChainingMapEntry<K, V> cur = entry.getNext();
